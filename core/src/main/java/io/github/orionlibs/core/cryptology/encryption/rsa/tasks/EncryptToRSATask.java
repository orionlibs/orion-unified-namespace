...
public class EncryptToRSATask
{
    ...
    {
        return encryptData(data, (PublicKey)Config.getObjectProp("public.rsa.key"), null);
    }
    ...
    {
        return encryptData(data, (PublicKey)Config.getObjectProp("public.rsa.key"), encryptionAlgorithmToUse);
    }
