package io.github.orionlibs.utilities.string;

import io.github.orionlibs.utilities.abstraction.OrionService;
import io.github.orionlibs.utilities.exception.Assert;
import io.github.orionlibs.utilities.string.tasks.ArePermutationsOfEachOtherTask;
import io.github.orionlibs.utilities.string.tasks.ConcatenateSeparatedBySpaceTask;
import io.github.orionlibs.utilities.string.tasks.ConcatenateTask;
import io.github.orionlibs.utilities.string.tasks.ConnectStringsByStringTask;
import io.github.orionlibs.utilities.string.tasks.ConvertFirstCharacterOfEachWordToUppercaseTask;
import io.github.orionlibs.utilities.string.tasks.ConvertFirstCharacterToUppercaseTask;
import io.github.orionlibs.utilities.string.tasks.ConvertToCommaAndSpaceSeparatedStringTask;
import io.github.orionlibs.utilities.string.tasks.ConvertToCommaSeparatedStringTask;
import io.github.orionlibs.utilities.string.tasks.CopyFromTheBeginningUpToTask;
import io.github.orionlibs.utilities.string.tasks.CopyStringTask;
import io.github.orionlibs.utilities.string.tasks.DeleteCharacterFromTheEndTask;
import io.github.orionlibs.utilities.string.tasks.DeleteLineSeparatorFromTheEndTask;
import io.github.orionlibs.utilities.string.tasks.DoesMatchRegularExpressionTask;
import io.github.orionlibs.utilities.string.tasks.DoesStringEndWithAnyTask;
import io.github.orionlibs.utilities.string.tasks.DoesStringStartWithAnyTask;
import io.github.orionlibs.utilities.string.tasks.FormatWith2CharactersTask;
import io.github.orionlibs.utilities.string.tasks.GenerateRandomNumericCodeTask;
import io.github.orionlibs.utilities.string.tasks.GenerateRandomStringTask;
import io.github.orionlibs.utilities.string.tasks.GetAlphabeticalValueTask;
import io.github.orionlibs.utilities.string.tasks.GetHashCodeTask;
import io.github.orionlibs.utilities.string.tasks.GetLongestCommonSubstringTask;
import io.github.orionlibs.utilities.string.tasks.GetSimilarityPercentageBetweenTask;
import io.github.orionlibs.utilities.string.tasks.IsLastCharacterAWhitespaceTask;
import io.github.orionlibs.utilities.string.tasks.IsOnlyAlphabeticalTask;
import io.github.orionlibs.utilities.string.tasks.IsOnlyAlphabeticalWithHyphensAndSpacesTask;
import io.github.orionlibs.utilities.string.tasks.IsOnlyAlphabeticalWithHyphensTask;
import io.github.orionlibs.utilities.string.tasks.PermuteStringTask;
import io.github.orionlibs.utilities.string.tasks.PrefixStringTask;
import io.github.orionlibs.utilities.string.tasks.SeparateByStringTask;
import io.github.orionlibs.utilities.string.tasks.ShuffleStringTask;
import io.github.orionlibs.utilities.string.tasks.SurroundWithStringTask;
